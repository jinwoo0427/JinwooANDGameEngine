...
public class Weapon : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        rightHandObj = transform.Find("RightHandPos").transform;
        leftHandObj = transform.Find("LeftHandPos").transform;
    ...
    private Quaternion CalculateAngle(GameObject muzzle)
    {
        ...
        Quaternion spreadRot = Quaternion.Euler(new Vector3(0, spread, 0));
